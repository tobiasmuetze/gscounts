---
title: "<center>Planning and analyzing group sequential designs for negative binomial outcomes using gscounts</center>"
...
In the followig, we briefly outline the statistical model. For more details, the reader is 
...
identical for all patients. In this case the syntax for determing the 
...
calcualted using the function `get_info_gsnb()`.
...
and the design parameters, i.e. sample size accrual periord, and study duration. 
...
# References
* T. Mütze, E. Glimm, H. Schmidli, and T. Friede. [*Group sequential designs for negative binomial outcomes.*](https://arxiv.org/abs/1707.04612) Submitted (2017).
